...
Provides OCR-based license plate reading and character mapping utilities.
Includes format validation and vehicle-plate association logic.
"""
...
class OCREngine:
    """Handles OCR operations for license plate text recognition."""
    ...
    def read_license_plate(self, license_plate_crop: np.ndarray) -> Tuple[Optional[str], Optional[float]]:
        """
